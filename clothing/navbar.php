...
<nav id="sidebar" class='mx-lt-7 bg-dark' >
		
		<div class="sidebar-list">
				<a href="index.php?page=home" class="nav-item nav-home"><span class='icon-field'><i class="fa fa-tachometer-alt "></i></span>Flacko 'Pretty Swag</a>
				...
				<a href="pos/index.php" class="nav-item nav-pos"><span class='icon-field'><i class="fa fa-file-invoice "></i></span>Point Of Sale</a>
